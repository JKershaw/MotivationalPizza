...
var DueStringBuilder = require('../util/DueStringBuilder');
...
module.exports = function () {
	...
	function buildTask(input) {
		...
		var dueStringBuilder = new DueStringBuilder();
		...
		if (input.dueDate) {
			task.dueDateFormatted = input.dueDate.toYMD();
			task.dueDateCountdownString = dueStringBuilder.build(input.dueDate);
		}
